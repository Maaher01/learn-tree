...
const createTeacher = async ({
	...
	const { rows } = await pool.query(
		"INSERT INTO teachers (name, email, password, department, mobile, birth_date, gender, address) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *",
		[name, email, password, department, mobile, birth_date, gender, address]
	);
	if (rows) {
		return rows[0];
	}
